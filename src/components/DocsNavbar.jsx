...
export default function DocsNavbar() {
  ...
  // Toggle search modal with Ctrl+K / Cmd+K
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* Global Documentation Search Overlay Modal */}
      {searchOpen && (
        <div className="docs-search-overlay-modal" onClick={() => setSearchOpen(false)}>
          <div className="docs-search-modal-container" onClick={(e) => e.stopPropagation()}>
            <div className="docs-search-modal-header">
              <svg className="docs-search-modal-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="11" cy="11" r="8" />
                <path d="M21 21l-4.3-4.3" />
              </svg>
              <input
              ...
              />
              <button className="docs-search-modal-close" onClick={() => setSearchOpen(false)}>
                esc
              </button>
            </div>
            ...
            <div className="docs-search-modal-body">
              {query.trim() === "" ? (
                ...
                <div className="docs-search-modal-results">
                  {results.map((item) => (
                    <div
                      key={item.href}
                    ...
                    >
                      ...
                      <h4 className="docs-search-result-title">{item.title}</h4>
                      <p className="docs-search-result-desc">{item.description}</p>
                    </div>
                  ))}
                </div>
              )}
