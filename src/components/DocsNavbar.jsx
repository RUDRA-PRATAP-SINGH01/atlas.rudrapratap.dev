      ...
      <div className="docs-navbar-container">
        <div className="docs-navbar-left">
          ...
          <nav className="docs-navbar-links" aria-label="Documentation navigation">
            <Link to="/project-docs/guide" className="docs-navbar-link">Guide</Link>
            <a href={resolveNavHref("#featured-projects", location.pathname)} className="docs-navbar-link">Architecture Design</a>
            <a href={resolveNavHref("#reference-card", location.pathname)} className="docs-navbar-link">Reference</a>
            <a href="https://github.com/rudrapratap-singh" target="_blank" rel="noopener noreferrer" className="docs-navbar-link docs-navbar-github-link">
