...
export const groups = /** @type {ArchGroup[]} */ ([
  { id: "g-client",    label: "Client layer",                 x: 16,  y: 40,   w: 960, h: 160 },
  { id: "g-sidecar",   label: "Sidecar proxy layer",          x: 16,  y: 260,  w: 960, h: 180 },
  { id: "g-limiter",   label: "Central limiter pool",         x: 16,  y: 500,  w: 960, h: 180 },
  { id: "g-state",     label: "Authoritative central state",  x: 16,  y: 740,  w: 960, h: 180 },
  { id: "g-obs",       label: "Observability stack",          x: 16,  y: 980,  w: 960, h: 160 },
]);
