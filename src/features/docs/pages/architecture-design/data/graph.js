...
export const groups = /** @type {ArchGroup[]} */ ([
  { id: "g-client",   label: "Client",                x: 256, y: 48,   w: 568, h: 152 },
  { id: "g-memory",  label: "In-memory LSM state",   x: 40,  y: 256,  w: 999, h: 148 },
  { id: "g-workers", label: "Background workers",     x: 187, y: 460,  w: 706, h: 146 },
  { id: "g-packages",label: "Engine packages",        x: 138, y: 662,  w: 804, h: 236 },
  { id: "g-disk",    label: "On disk",                x: 158, y: 954,  w: 764, h: 232 },
]);
...
export const nodes = /** @type {ArchNode[]} */ ([
  ...
  {
    id: "pending-batch",
    label: "pendingBatch buffer",
    kind: "memory",
    x: 80, y: 304, w: 175, h: 68,
    path: "internal/db/batch.go",
    summary: "In-memory staging slice buffering incoming Put/Delete mutations before batchFlusher triggers WAL fsync and active memtable application.",
  ...
  },
  {
    ...
    label: "block cache",
    kind: "memory",
    x: 764, y: 711, w: 130, h: 64,
    path: "internal/sstable/cache.go",
    summary: "LRU block cache avoiding redundant disk reads for uncompressed SSTable data blocks across point lookups.",
    guideHref: "/project-docs/guide/core-components/sstable",
  },
  {
    id: "manifest",
...
export const edges = /** @type {ArchEdge[]} */ ([
  ...
  // api → pending-batch
  {
    id: "e23", from: "api", to: "pending-batch",
    kind: "data-flow", timing: "sync",
    label: "Stages Put/Delete records",
    description: "writeRecord appends incoming Put/Delete records directly into db.pendingBatch before batchFlusher triggers WAL fsync.",
  },
  // sstable → block-cache
  {
    id: "e24", from: "sstable", to: "block-cache",
    kind: "data-flow", timing: "sync",
    label: "Caches SST data blocks",
    description: "sstable.Reader looks up uncompressed blocks in LRU block cache before performing disk I/O.",
  },
]);
