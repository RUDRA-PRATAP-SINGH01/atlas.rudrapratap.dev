...
// → fast: no transmission, no compilation`}</GoCodeBlock>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 28 }}>
                {[
                  { title: "Redis Single-Thread Ceiling", icon: "Warning:", color: "#ec4899", body: "Redis executes all commands in a single thread. At ~100K ops/sec, CPU becomes the bottleneck. With 20 Lua calls per request on the cold path, the theoretical maximum is ~5,000 RPS before Redis saturates. singleflight and denial caching are essential to stay under this ceiling at high concurrency." },
