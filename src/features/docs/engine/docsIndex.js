export const docsIndex = [
  ...
  {
    title: "Introduction to Distributed Rate Limiter",
    category: "Rate Limiter",
    description: "Overview of the high-throughput, horizontally scalable rate limiting platform designed for microservices.",
    href: "/project-docs/guide/rate-limiter/introduction",
    keywords: "introduction rate limiter distributed sentinel redis sliding window lua",
  },
  {
    title: "System Architecture (Rate Limiter)",
    category: "Rate Limiter",
    description: "Three-tier architecture topology: Sidecar Proxy, Central Limiter, and Redis HA cluster.",
    href: "/project-docs/guide/rate-limiter/architecture",
    keywords: "system architecture topology sidecar proxy central limiter redis sentinel three-tier design",
  },
  {
    title: "Request Lifecycle (Rate Limiter)",
    category: "Rate Limiter",
    description: "Walkthrough of client request validation, sidecar interception, quota evaluations, and response compilation.",
    href: "/project-docs/guide/rate-limiter/request-lifecycle",
    keywords: "request lifecycle validation intercept sidecar quota checks response client",
  },
  {
    title: "Design Decisions (Rate Limiter)",
    category: "Rate Limiter",
    description: "Key architectural decisions, protocol selection, state models, and configuration defaults.",
    href: "/project-docs/guide/rate-limiter/design-decisions",
    keywords: "design decisions architecture protocol selection state models configuration keys",
  },
  {
    title: "System Invariants (Rate Limiter)",
    category: "Rate Limiter",
    description: "Formal specification of systems engineering invariants, atomic updates, fencing, and failover boundaries.",
    href: "/project-docs/guide/rate-limiter/system-invariants",
    keywords: "system invariants atomic updates fencing failover boundaries rules correctness safety",
  },
  {
    title: "Engineering Trade-offs (Rate Limiter)",
    category: "Rate Limiter",
    description: "In-depth comparison of token bucket vs sliding window, Sentinel vs Cluster, sidecar vs SDK, and Lua vs transactions.",
    href: "/project-docs/guide/rate-limiter/engineering-tradeoffs",
    keywords: "engineering tradeoffs token bucket sliding window sentinel cluster sidecar sdk lua transactions",
  },
  {
    title: "Algorithms & Lua Scripts",
    category: "Rate Limiter",
    description: "Atomic execution in Redis. Token bucket and sliding window algorithms modeled inside Lua scripts.",
    href: "/project-docs/guide/rate-limiter/lua-scripts",
    keywords: "algorithms lua scripts redis token bucket sliding window atomic execution evaluation",
  },
  {
    title: "Hierarchical Quotas",
    category: "Rate Limiter",
    description: "Multi-level limits enforcing Global, Tenant, User, and Endpoint rules in a single execution.",
    href: "/project-docs/guide/rate-limiter/hierarchical",
    keywords: "hierarchical quotas multi-level limits global tenant user endpoint execution noisy-neighbor",
  },
  {
    title: "Circuit Breaker",
    category: "Rate Limiter",
    description: "Fail-soft protection mechanisms. State transitions, threshold rules, and integration points.",
    href: "/project-docs/guide/rate-limiter/circuit-breaker",
    keywords: "circuit breaker fail soft protection state machine transitions thresholds integration",
  },
  {
    title: "Idempotency Layer",
    category: "Rate Limiter",
    description: "Exactly-once execution semantics. Deduplication keys, status flows, and fencing tokens.",
    href: "/project-docs/guide/rate-limiter/idempotency",
    keywords: "idempotency layer exactly once deduplication keys status flows fencing tokens client",
  },
  {
    title: "Redis & Sentinel HA",
    category: "Rate Limiter",
    description: "High availability design, Sentinel failover monitoring, Pub/Sub updates, and connection pools.",
    href: "/project-docs/guide/rate-limiter/redis-ha",
    keywords: "redis sentinel ha high availability failover monitoring pubsub connection pools",
  },
  {
    title: "Intelligent Routing",
    category: "Rate Limiter",
    description: "Gateway load balancing. Scoring algorithms, latency EMA, and automatic retry failovers.",
    href: "/project-docs/guide/rate-limiter/routing",
    keywords: "intelligent routing gateway load balancing score logic latency ema retry failover",
  },
  {
    title: "Configuration Reference (Rate Limiter)",
    category: "Rate Limiter",
    description: "Limiter and sidecar configuration options, environment variables, and pool sizes.",
    href: "/project-docs/guide/rate-limiter/configuration",
    keywords: "configuration reference limiter sidecar environment variables options pool sizes",
  },
  {
    title: "Observability",
    category: "Rate Limiter",
    description: "OpenTelemetry tracing, Prometheus scraping metrics, Grafana dashboards, and audit logs.",
    href: "/project-docs/guide/rate-limiter/observability",
    keywords: "observability opentelemetry tracing prometheus metrics grafana dashboard audit logs",
  },
  {
    title: "Benchmarks & Performance (Rate Limiter)",
    category: "Rate Limiter",
    description: "Load testing results, latency percentiles, throughput bounds, and profiling analysis.",
    href: "/project-docs/guide/rate-limiter/benchmarks",
    keywords: "benchmarks performance load testing latency percentiles throughput bounds profiling",
  },
  {
    title: "Operations & Runbooks",
    category: "Rate Limiter",
    description: "Operational incident response manuals, master failure remediation, and cold start recovery.",
    href: "/project-docs/guide/rate-limiter/runbooks",
    keywords: "operations runbooks incident response master recovery backup remediation manuals",
  },
  {
    title: "Chaos Engineering & Testing (Rate Limiter)",
    category: "Rate Limiter",
    description: "Fault injection methodologies, partition simulations, and recovery correctness audits.",
    href: "/project-docs/guide/rate-limiter/chaos",
    keywords: "chaos engineering testing fault injection partitions simulations recovery audits correctness",
  },
];
